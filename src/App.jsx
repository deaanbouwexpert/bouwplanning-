...
export default function App() {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#F0F2F5",
      ...
      {/* header */}
      <header style={{ background:"#1C2B3A", color:"#fff",
        boxShadow:"0 2px 8px rgba(0,0,0,.3)", position:"sticky", top:0, zIndex:20 }}>

        {/* Rij 1: logo + gebruiker + uitloggen */}
        <div style={{ display:"flex", alignItems:"center", padding:"6px 12px", gap:8, height:44 }}>
          <img src="data:image/png;base64," alt="De Aanbouw Expert" style={{ height:32, objectFit:"contain", flexShrink:0 }} />
          <div style={{ flex:1 }} />
          {currentUser.role === "admin" && (
            <button onClick={()=>setShowAdmin(v=>!v)}
              style={{ background: showAdmin?"#E65100":"rgba(255,255,255,.12)",
                border:"none", color:"#fff", padding:"5px 10px", borderRadius:6,
                fontWeight:700, cursor:"pointer", fontSize:11, position:"relative" }}>
              👥
          ...
          <div style={{ fontSize:11, color:"#CFD8DC" }}>👤 {currentUser.name}</div>
          <button onClick={()=>{ clearSession(); setCurrentUser(null); }}
            style={{ background:"rgba(255,255,255,.12)", border:"none", color:"#fff",
              padding:"5px 10px", borderRadius:6, fontWeight:600, cursor:"pointer", fontSize:11 }}>
            Uit
          </button>
        </div>

        {/* Rij 2: tabs — scrollbaar op mobiel */}
        <div style={{ display:"flex", overflowX:"auto", gap:2, padding:"0 8px 4px",
